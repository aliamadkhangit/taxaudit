...
export default function ServicesSection() {
  ...
  return (
    <motion.section
      ...
      className="py-24 bg-linear-to-b from-white to-gray-50/50"
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          {services.map((service) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-linear-to-br ${service.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
              ></div>
              ...
              <div className="relative p-6 z-10">
                <motion.div
                  ...
                  className="text-5xl mb-5 transition-transform duration-300 group-hover:scale-110 inline-block"
                >
                  {service.icon}
                </motion.div>
        ...
        <motion.div variants={fadeItem} className="text-center mt-16">
